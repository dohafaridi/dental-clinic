...
import CMSPages from './routes/CMSPages.routes';
...
app.listen(serverConfig.port, (error) => {
  if (!error) {
    console.log(`dental-clinic is running on port: ${serverConfig.port}! Build something amazing!`); // eslint-disable-line
  }
});
